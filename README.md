...
[![Build Status](https://travis-ci.org/abadojack/swot.svg?branch=master)](https://travis-ci.org/abadojack/swot) [![GoDoc](https://godoc.org/github.com/abadojack/swot?status.png)](http://godoc.org/github.com/abadojack/swot)
...
`go get -u github.com/abadojack/swot`

### Usage

```go
import "github.com/abadojack/swot"
```

#### Verify Email Addresses

```go
swot.IsAcademic("abadojack@students.uonbi.ac.ke")	//true
swot.IsAcademic("pedro@ugr.es")				//true
swot.IsAcademic("abadojack@leerilly.net")		//false
swot.IsAcademic("abadojack@gmail.com")			//false
```
